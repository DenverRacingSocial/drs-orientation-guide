  ...
  return (
    <div className="max-w-7xl mx-auto px-4 pb-10 pt-2 transition-all duration-300 min-h-screen bg-gray-950 text-white">
      ...
      <div className="text-center py-2 md:py-4">
        <h1 className="text-md md:text-3xl font-extrabold text-white">VIP Orientation Guide (Rep View)</h1>
      </div>
        ...
        <div className="w-full md:w-2/3">
          {uniquePhases.map((phaseName) => {
            ...
            return (
              ...
              >
                <div className={classNames("sticky z-30 top-20 md:top-24 px-4 py-2 rounded font-semibold border mb-4 text-lg text-white", phaseColor)}>
                  {phaseName}
                </div>
